 <footer class="bg-white fixed bottom-0 left-0 right-0 z-50">
        <div
            ...
            <div class="flex -mx-1">
                <!-- Telegram -->
                <a href="https://t.me/mycollegee" class="mx-1 text-gray-600 hover:text-blue-500" aria-label="Telegram">
                ...
                <!-- Gmail -->
                <a href="mailto:max.021persia@gmail.com" class="mx-1 text-gray-600 hover:text-red-500" aria-label="Gmail">
                    <svg class="w-6 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path
